...
function updateRTDB(device_id, pin, state){
    // console.log(state);
    updateDatastream(device_id, pin, state)
}

function receieveRTDB(device_id, pin, state, updateMessage ){
    // console.log(pin,state);
    updateRTDB(device_id, pin,state)
